 ...
 *
 * The card deliberately carries no controls — it shows what the pipeline *is*
 * (its tool chain and which configuration is loaded), while all editing happens
 * in the Configuration panel. One setting, one place.
 */
